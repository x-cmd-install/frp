...
[![x-cmd/install — frp Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/frp.svg?lang=zh)](https://x-cmd.com/install/frp)
...
合计: **59,956** 行代码（覆盖前 5 种语言、共 **453** 个文件）。
...
- **最新版本**: `v0.71.0` (2026-08-14)
- **最近提交**: 2026-09-09
- **Release 含资产**: 18 个

## 流行度

- **Star**: 109,630 · **Fork**: 15,220 · **开放 issue**: 4,156 · **贡献者**: 135

## 累计统计

- **发布数**: 116 · **已合并 PR**: 868 · **开放 PR**: 13 · **已关闭 issue**: 4117 · **开放 issue**: 39 · **提交数**: 1524

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-27 | 0 | 4 | 9 | 3 | 10 | 6 |
| last60d | 2026-07-28 | 1 | 25 | 10 | 19 | 11 | 24 |
| 90d | 2026-06-28 | 3 | 60 | 12 | 34 | 12 | 57 |
| last180d | 2026-03-30 | 6 | 90 | 12 | 74 | 15 | 84 |
| 360d | 2025-10-01 | 9 | 174 | 13 | 201 | 17 | 165 |
| last720d | 2024-10-06 | 17 | 240 | 13 | 606 | 19 | 227 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/frp.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T04:54:47Z._
